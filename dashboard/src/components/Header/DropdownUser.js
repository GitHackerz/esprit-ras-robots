        ...
        <div className="relative">
            ...
            >
                <span className="hidden text-right lg:block">
                    ...
                    <span className="block text-xs">
                        {user?.isAdmin ? 'Admin' : 'Organizing Committee'}
                    </span>
                </span>
            ...
            >
                ...
                <Button
                    ...
                    startContent={<CiLogout className="" />}
                    className="bg-transparent flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                >
                    Log Out
                </Button>
            </div>
